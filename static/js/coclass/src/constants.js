...
export const QUESTION_TYPE_DESCRIPTION = 'description-type';
export const QUESTION_TYPE_PATH = 'path-type';
export const PRE_QUESTION = 0;
export const POST_QUESTION = 1;
